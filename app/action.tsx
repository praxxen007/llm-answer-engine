...
export async function processAndVectorizeContent(
  ...
  try {
    // Process and vectorize content from search results
    ...
    // Retrieve results from Pinecone vector store
    const pineconestore = await PineconeStore.fromExistingIndex(
      embeddings,
      {pineconeIndex},
    );
    const pinecone_query = query+ " If you can not find any relevant documents then please only return - 'No relevant Documents' "
    const pineconeResults = await pineconestore.similaritySearch(pinecone_query, numberOfSimilarityResults);
